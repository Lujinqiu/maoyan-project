...
>>>>>>> 4e640b9b5b74a783c0ee17d8529cce0b1eece581
            <div class="title-block box-flex middle">
                <div class="title line-ellipsis">
                    <span>{{it.nm}}</span>
                    <span class="price-block">
...
>>>>>>> 5e103b5da802bb2d08a0cf8577fc245a2437c05d
        ...
        <div class="discount-block">
          <div>
            <div class="discount-label normal platform">
              <img
                src="data:image/png;base64,"
                alt
              >
            </div>
<<<<<<< HEAD
...
export default {
  ...
  created() {
    ...
    xhr.open(
      "get",
      "http://localhost:4008/movie/ajax/cinemaList?day=2019-01-22&offset=0&limit=20&districtId=-1&lineId=-1&hallType=-1&brandId=-1&serviceId=-1&areaId=-1&stationId=-1&item=&updateShowDay=true&reqId=1548155918452&cityId=20",
      true
    );
    xhr.send();
  }
...
.list-wrap .location-block .region {
  margin-left: 5px;
}
.list-wrap .title-block .label-block {
  height: 17px;
  line-height: 17px;
  margin-top: 4px;
  margin-bottom: 4px;
...
.list-wrap .title-block .label-block > div {
  position: relative;
